...
import { GetProfileHandler } from '../telegram/handlers/getProfile.handler';
import { Context } from 'telegraf';
import { HandlerSteps } from 'src/enums/handler-steps.enum';
import { BotKeyboard } from 'src/enums/BotKeyboard.enum';

@Injectable()
export class GetProfileForwarder implements IForwarder {
  constructor(
